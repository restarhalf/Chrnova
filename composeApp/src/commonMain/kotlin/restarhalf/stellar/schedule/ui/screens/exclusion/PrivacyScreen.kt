            ...
            Box(modifier = Modifier.verticalScroll(scrollState).padding(16.dp)) {
                Markdown(
                    content =
                            ...
                            "## 一、关于软件性质的声明\n" +
                            "\n" +
                            "1. 本项目**并非大连民族大学官方应用**，与学校及其教务部门无任何关联、赞助或背书关系。\n" +
                            "2. 本软件为个人独立开发，仅为方便学生日常查看课表、成绩等教务信息而提供。\n" +
                            "3. 开发者保留随时修改、暂停或终止本软件功能的权利，无需事先通知。\n" +
                            "\n" +
                            "## 二、关于教务数据与账号安全\n" +
                            "\n" +
                            "1. 课表同步、成绩查询、考试安排等功能**依赖于学校教务系统**，如教务系统接口变动、字段调整或服务不可用，可能导致相关功能无法正常使用。\n" +
                            ...
                            "2. 在适用法律允许的最大范围内，开发者**不对因使用或无法使用本软件而产生的任何直接、间接、偶然、特殊或结果性损失**（包括但不限于错过课程、错过考试、成绩数据丢失、账号信息泄露、业务中断或其他损失）承担责任，即使开发者已被告知可能发生此类损害。\n" +
                    ...
                    typography = DefaultMarkdownTypography(
                        h1 = MiuixTheme.textStyles.title2.copy(fontWeight = FontWeight.Bold, fontSize = 22.sp),
                        h2 = MiuixTheme.textStyles.title4.copy(fontWeight = FontWeight.Bold, fontSize = 20.sp),
                        h3 = MiuixTheme.textStyles.title4.copy(fontWeight = FontWeight.Bold, fontSize = 18.sp),
                        h4 = MiuixTheme.textStyles.title4.copy(fontWeight = FontWeight.Bold, fontSize = 16.sp),
                        h5 = MiuixTheme.textStyles.headline1.copy(fontWeight = FontWeight.Bold, fontSize = 15.sp),
                        h6 = MiuixTheme.textStyles.headline2.copy(fontWeight = FontWeight.Bold, fontSize = 14.sp),
                        text = MiuixTheme.textStyles.body2.copy(fontSize = 14.sp),
