            ...
            Box(modifier = Modifier.verticalScroll(scrollState).padding(16.dp)) {
                Markdown(
                    ...
                    typography = DefaultMarkdownTypography(
                        ...
                        h2 = MiuixTheme.textStyles.title4.copy(fontWeight = FontWeight.Bold),
                        h3 = MiuixTheme.textStyles.title4.copy(fontWeight = FontWeight.Bold),
                        ...
                        text = MiuixTheme.textStyles.body2,
